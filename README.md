...
The current latest version is [`bacchilu/static-server:3.0.6`](https://hub.docker.com/r/bacchilu/static-server).
...
## Running from Docker Hub
    ...
    docker run --env-file docker/.env -p 8000:8000 bacchilu/static-server:3.0.6
